...
for I in DSM/*DSM_N*/; do
  mkdir -p ../SDMI.IFSAR.WIGGLE_ROOM/DSM.tarballs/`basename $I`
  cd $I
  echo processing... 
  pwd
  ...
  cd ../../
  pwd
  echo mv $I`basename $I`.tar.gz ../SDMI.IFSAR.WIGGLE_ROOM/DSM.tarballs/`basename $I`
  mv $I`basename $I`.tar.gz ../SDMI.IFSAR.WIGGLE_ROOM/DSM.tarballs/`basename $I`
  echo " " 
done
